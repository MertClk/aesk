...
if(aesk_CONFIG_INCLUDED)
  return()
endif()
set(aesk_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(aesk_SOURCE_PREFIX /home/mert/projects/aesk/src/aesk)
  set(aesk_DEVEL_PREFIX /home/mert/projects/aesk/src/aesk/cmake-build-debug/devel)
  set(aesk_INSTALL_PREFIX "")
  set(aesk_PREFIX ${aesk_DEVEL_PREFIX})
else()
  set(aesk_SOURCE_PREFIX "")
  set(aesk_DEVEL_PREFIX "")
  set(aesk_INSTALL_PREFIX /usr/local)
  set(aesk_PREFIX ${aesk_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'aesk' is deprecated")
...
set(aesk_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/usr/include/eigen3;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  set(aesk_INCLUDE_DIRS "")
  set(_include_dirs "/usr/include/eigen3;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${aesk_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'aesk' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'aesk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mert/projects/aesk/src/aesk/${idir}'.  ${_report}")
    endif()
    _list_append_unique(aesk_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND aesk_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mert/projects/aesk/src/aesk/cmake-build-debug/devel/lib;/home/mert/projects/catkin_simple/devel/lib;/home/mert/projects/catkin_ws/devel/lib;/home/mert/projects/velodyne_ros/devel/lib;/home/mert/projects/velodyne_multi/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(aesk_LIBRARY_DIRS ${lib_path})
      list(APPEND aesk_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'aesk'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND aesk_LIBRARIES ${lib})
    endif()
  endif()
...
set(aesk_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${aesk_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 aesk_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${aesk_dep}_FOUND)
      find_package(${aesk_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${aesk_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(aesk_INCLUDE_DIRS ${${aesk_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(aesk_LIBRARIES ${aesk_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${aesk_dep}_LIBRARIES})
  _list_append_deduplicate(aesk_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(aesk_LIBRARIES ${aesk_LIBRARIES})

  _list_append_unique(aesk_LIBRARY_DIRS ${${aesk_dep}_LIBRARY_DIRS})
  list(APPEND aesk_EXPORTED_TARGETS ${${aesk_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${aesk_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
